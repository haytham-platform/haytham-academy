...
import { BarChart3, Bell, BookOpenCheck, CalendarDays, FileText, GraduationCap, LayoutDashboard, LogOut, ReceiptText, Users } from "lucide-react";
      ...
      <div className="border-b border-border p-5">
        <Link href="/" className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted">لوحة الأستاذ</p>
          </div>
        </Link>
      </div>
